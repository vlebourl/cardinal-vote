...
class VotingApp {
    ...
    async loadVoterCounter() {
        ...
        try {
            ...
            // Announce to screen readers
            this.announceToScreenReader(`Compteur de votes mis à jour: ${voterCount} ${voterCount <= 1 ? 'personne a' : 'personnes ont'} déjà voté`);
...
class ResultsApp {
    ...
    displayResults(data) {
        ...
        if (totalVotes) {
            ...
            const totalEvaluations = Object.values(data.summary || {})
